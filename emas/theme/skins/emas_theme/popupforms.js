...
This overrides CMFPlone's popupform.js to fix the login overlay to not
reload when a user is logging in from the "logged_out" page but redirect
    ...
    $('#portal-personaltools a[href$="/login"], #portal-personaltools a[href$="/login_form"], .discussion a[href$="/login"], .discussion a[href$="/login_form"]').prepOverlay(
        {
            ...
            noform: function () {
                if ((location.href.search(/pwreset_finish$/) >= 0) ||
                    (location.href.search(/logged_out$/) >= 0)) {
                    return 'redirect';
                } else {
                    return 'reload';
                }
            ...
            redirect: function () {
                ...
                } else if (href.search(/logged_out$/) >= 0) {
                    return href.slice(0, href.length-10);
                } else {
                    return href;
                }
            }
