(function() {
  ...
  Annotator.Plugin.Categories = (function() {
    __extends(Categories, Annotator.Plugin);
    ...
    function Categories(element, categories) {
      ...
      this.updateField = __bind(this.updateField, this);      this.options.categories = categories;
    }
